...
function Cadastro(props) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const sucesso = await props.cadastrar( nome, login, senha, img, nacionalidade );
