...
function Login(props){
    ...
    return(
        <>
            <div class="flex min-h-full rounded-md flex-col justify-center px-6 py-12 lg:px-8">
                <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                    <img src="https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=indigo&shade=500" alt="Your Company"
                        class="mx-auto h-10 w-auto" />
                    <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-white">Faça login na sua conta
                    </h2>
                </div>
                ...
                <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form action="#" method="POST" class="space-y-6">
                        ...
                        <div class="flex-col sm:flex-row sm:flex sm:gap-3 sm:justify-between items-center">
                            <div class="flex items-center gap-2">
                                ...
                                <div class="text-sm">
                                    <label for="remember" class="font-medium text-white">Lembre-se de mim</label>
                                </div>
                            </div>
                        ...
                        <div>
                            <button type="submit"
                                class="flex w-full justify-center rounded-md bg-indigo-500 px-3 py-1.5 text-sm/6 font-semibold text-white hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Entrar</button>
                        </div>

                        <div class="flex flex-col text-gray-100 gap-3">
                            <div class="divider">
                                <span class="line"></span>
                                <span class="text-sm/6 font-medium">Or continue com</span>
                                <span class="line"></span>
                            </div>

                            <div class="flex flex-col gap-3.5">
                                <button
                                    class="flex items-center justify-center gap-1.5 font-medium text-sm px-5 py-2 bg-gray-800 cursor-pointer rounded-lg hover:bg-gray-700">
